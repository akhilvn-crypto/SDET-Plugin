...
| `/regression [scope]` | Runs the existing Playwright suite (or a file/`@tag` subset) and diagnoses any failures. |
...
/sdet-pipeline:regression
/sdet-pipeline:regression @smoke
